...
class ScreenTextSelector:
    def __init__(self):
        ...
        #self.root.minsize(450, 450)    # Minimum size to prevent too small window
        #Go to- def create_ui(self): for scree size
    ...
    def create_ui(self):
        ...
        min_width = 350  # Reduced minimum width
        min_height = 430  # Reduced minimum height
